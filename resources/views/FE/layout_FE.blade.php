...
<head>
    ...
    <!-- Favicon -->
    <link href="{{asset('public/FE')}}/img/favicon.ico" rel="icon">
...
<body>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Cinema</a>, All Right Reserved. 
    ...
    <script src="{{asset('public/FE')}}/lib/wow/wow.min.js"></script>
    ...
    <script src="{{asset('public/FE')}}/lib/counterup/counterup.min.js"></script>
